...
func NewHTTPClient(opts HTTPClientOptions) (*http.Client, error) {
	...
	headers := map[string]string{
		userAgent: fmt.Sprintf("PDrive CLI %s", opts.AppVersion),
	}
	...
	client, err := HTTPClient(&clientOpts)
	if err != nil {
		return nil, err
	}
...
// TODO
func HTTPClient(g *ghAPI.ClientOptions) (http.Client, error) {
